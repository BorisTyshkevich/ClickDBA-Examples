...
Read docs -  https://clickhouse.com/docs/guides/developer/on-the-fly-mutations and the file summaries/path-updates-howto.md to understand better patch parts usage. After that, go deeper into the LOGICAL_ERROR problem.
